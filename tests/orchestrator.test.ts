...
describe("orchestrator", () => {
  ...
  it("emits source-core monitor events without letting sink failures fail orchestration", async () => {
    ...
    expect(implementationEvents.every((event) => event.parentSpanId === runEvents[0].spanId)).toBe(true);
  ...
  it("pauses clean pushed work with incomplete recovery evidence instead of retrying implementation", async () => {
