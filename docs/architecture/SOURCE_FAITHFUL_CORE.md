...
| Dashboard and loopback HTTP API | `src/http-server.ts`, `dashboard/` | Optional observability extension. It reads durable state and must not become a scheduler control plane. |
